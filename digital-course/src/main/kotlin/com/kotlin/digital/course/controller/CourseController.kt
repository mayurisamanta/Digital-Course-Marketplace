...
class CourseController(
    ...
    fun getAllCourse(authentication: Authentication, @RequestParam("search") search: String): ResponseEntity<ApiResp<*>> {
        val userSessionBean = authentication.details as UserSessionBean
        log.info("Email: ${userSessionBean.emailId} -> Getting all course")
        return ResponseEntity.status(HttpStatus.OK).body(courseService.getAllCourse(userSessionBean, search))
    }
